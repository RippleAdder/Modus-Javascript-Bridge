...
## Documentation
-   [Modus Bridge API](documentation/BRIDGE_DOCUMENTATION.md)

## More Documentation

The following sections will eventually be put in the BRIDGE_DOCUMENATION.md file under the "documentation" folder. The api documentation will be auto generated by documentationjs
